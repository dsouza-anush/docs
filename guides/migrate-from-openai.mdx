...
<Note>
**Already using Anthropic?** If you're migrating from Anthropic's API (not OpenAI), you can use the [Messages API](/inference-api/messages) instead. It provides native Anthropic SDK compatibility—just change your base URL and API key.
</Note>
...
- [Messages API](/inference-api/messages) - Native Anthropic SDK for Claude models

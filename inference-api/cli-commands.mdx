...
The Heroku AI CLI plugin provides commands to provision, manage, and interact with AI models directly from your terminal. These commands help you create model resources, make inference requests, manage MCP servers, and access AI tools.

## Installation

The AI CLI plugin is included with the Heroku CLI. If you need to install or update the Heroku CLI, visit [heroku.com/cli](https://heroku.com/cli).
...
2. **Make an inference request**
   ```bash
   heroku ai:models:call INFERENCE --app my-app --prompt "Hello!"
   ```

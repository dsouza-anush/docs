...
<section style={{ margin: '0 calc(-1 * min(8vw, 96px)) 3rem', padding: '0 min(8vw, 96px)' }}>
  ...
  >
    ...
    >
      <div style={{ fontSize: '0.82rem', letterSpacing: '0.08em', textTransform: 'uppercase', opacity: 0.85 }}>Claude 4 Sonnet</div>
      <div style={{ fontSize: '1.12rem', fontWeight: 600, lineHeight: 1.32 }}>
        Flagship reasoning model with extended thinking, vision, and tool calling.
      </div>
      <div style={{ fontSize: '0.92rem', opacity: 0.85 }}>Reach for high-stakes copilots, complex code, and long documents.</div>
    ...
    >
      <div style={{ fontSize: '0.82rem', letterSpacing: '0.08em', textTransform: 'uppercase', opacity: 0.85 }}>Claude 3.5 Haiku</div>
      <div style={{ fontSize: '1.12rem', fontWeight: 600, lineHeight: 1.32 }}>
        Fastest Claude tier with full 200K context for responsive, low-cost assistants.
      </div>
      <div style={{ fontSize: '0.92rem', opacity: 0.85 }}>Ideal for support chat, orchestrators, and high-volume pipelines.</div>
      <span style={{ fontSize: '0.88rem', opacity: 0.8 }}>View details →</span>
    </a>

  ...
  <div style={{ position: 'relative', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '3rem', alignItems: 'center' }}>
    ...
    <div style={{
      ...
      <ul style={{ listStyle: 'disc', paddingLeft: '1.25rem', lineHeight: 1.6, color: 'rgba(235,235,255,0.82)' }}>
        <li>Prototype with Claude 3.5 Haiku or Nova Lite to validate prompts quickly.</li>
        <li>Upgrade to Claude 3.5 Sonnet for higher quality or image understanding.</li>
  ...
  >
    <a
      ...
      style={{
        ...
        boxShadow: '0 30px 70px rgba(80,68,220,0.26)',
    ...
    >
      <div style={{ fontSize: '0.85rem', letterSpacing: '0.08em', textTransform: 'uppercase', opacity: 0.85 }}>Claude 4 Sonnet</div>
      <div style={{ fontSize: '1.2rem', fontWeight: 600, lineHeight: 1.35 }}>
        Deep reasoning with extended thinking, multimodal support, and enterprise-grade guardrails.
      </div>
      <div style={{ fontSize: '0.95rem', opacity: 0.9 }}>Best when stakes are high: research copilots, complex coding, strategic decisions.</div>
      <span style={{ fontSize: '0.9rem', opacity: 0.9 }}>View details →</span>
    </a>
    ...
    <a
      ...
      style={{
        ...
        boxShadow: '0 30px 70px rgba(36,140,200,0.24)',
        border: '1px solid rgba(255,255,255,0.1)',
        backdropFilter: 'blur(18px)',
        display: 'flex',
        flexDirection: 'column',
    ...
    >
      <div style={{ fontSize: '0.85rem', letterSpacing: '0.08em', textTransform: 'uppercase', opacity: 0.85 }}>Claude 3.5 Haiku</div>
      <div style={{ fontSize: '1.2rem', fontWeight: 600, lineHeight: 1.35 }}>
        Fastest Claude tier with 200K context—perfect for live agents, support chat, and API orchestration.
      </div>
      <div style={{ fontSize: '0.95rem', opacity: 0.9 }}>Choose when throughput and predictable spend matter most.</div>
      <span style={{ fontSize: '0.9rem', opacity: 0.9 }}>View details →</span>
    </a>
    ...
    <a
      ...
      style={{
        ...
        boxShadow: '0 30px 70px rgba(255,136,76,0.24)',
        border: '1px solid rgba(255,255,255,0.1)',
        backdropFilter: 'blur(18px)',
        display: 'flex',
        flexDirection: 'column',
    ...
    >
      <div style={{ fontSize: '0.85rem', letterSpacing: '0.08em', textTransform: 'uppercase', opacity: 0.85 }}>Stable Image Ultra</div>
      <div style={{ fontSize: '1.2rem', fontWeight: 600, lineHeight: 1.35 }}>
        Enterprise-quality text-to-image model with precise prompt adherence and reproducible seeds.
      </div>
      <div style={{ fontSize: '0.95rem', opacity: 0.9 }}>Ideal for marketing, product visualization, and creative tooling.</div>
      <span style={{ fontSize: '0.9rem', opacity: 0.9 }}>View details →</span>
    </a>
  </div>
</section>
...
<section style={{ maxWidth: '1400px', margin: '0 auto 2.5rem', padding: '0 4vw' }}>

...
## Table of Contents [expand]
        ...
        - [extended_thinking Object](#extended_thinking-object)

        - [tools Array of Objects](#tools-array-of-objects)

        - [tool_choice Object](#tool_choice-object)

        - [messages Array of Objects](#messages-array-of-objects)
        ...
        - [Example Request with Tools](#example-request-with-tools)

        - [Example Response with Tools](#example-response-with-tools)
...
View our [available chat models](https://devcenter.heroku.com/articles/heroku-inference-api-model-cards).

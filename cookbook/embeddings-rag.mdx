...
<section style={{ margin: '0 calc(-1 * min(8vw, 96px)) 2rem', padding: '0 min(8vw, 96px)' }}>
  <div style={{
    ...
    <h3 style={{ marginTop: 0, color: '#ffffff', fontWeight: '600' }}>Core pipeline</h3>
...
<section style={{ margin: '0 calc(-1 * min(8vw, 96px)) 2rem', padding: '0 min(8vw, 96px)' }}>
  <div style={{
    ...
    <h3 style={{ marginTop: 0, color: '#ffffff', fontWeight: '600' }}>Prompt template</h3>
...
<section style={{ margin: '0 calc(-1 * min(8vw, 96px)) 2rem', padding: '0 min(8vw, 96px)' }}>
  <div style={{
    ...
    <h3 style={{ marginTop: 0, color: '#ffffff', fontWeight: '600' }}>Best practices</h3>
    <ul style={{ color: '#ffffff', lineHeight: '1.7' }}>

...
<section style={{ margin: '0 calc(-1 * min(8vw, 96px)) 2rem', padding: '0 min(8vw, 96px)' }}>
  <div style={{
    ...
    <h3 style={{ marginTop: 0, color: '#ffffff', fontWeight: '600' }}>Template anatomy</h3>
    ...
    <p style={{ marginBottom: 0, opacity: 0.95, color: '#ffffff' }}>
...
<section style={{ margin: '0 calc(-1 * min(8vw, 96px)) 2rem', padding: '0 min(8vw, 96px)' }}>
  <div style={{
    ...
    <h3 style={{ marginTop: 0, color: '#ffffff', fontWeight: '600' }}>Checker workflow</h3>
...
<section style={{ margin: '0 calc(-1 * min(8vw, 96px)) 2rem', padding: '0 min(8vw, 96px)' }}>
  <div style={{
    ...
    <h3 style={{ marginTop: 0, color: '#ffffff', fontWeight: '600' }}>Cycle overview</h3>
    <ol style={{ color: '#ffffff', lineHeight: '1.7' }}>

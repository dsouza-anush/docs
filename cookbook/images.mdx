...
<section style={{ margin: '0 calc(-1 * min(8vw, 96px)) 2rem', padding: '0 min(8vw, 96px)' }}>
  <div style={{
    ...
    <h3 style={{ marginTop: 0, color: '#ffffff', fontWeight: '600' }}>When to enable</h3>
...
<section style={{ margin: '0 calc(-1 * min(8vw, 96px)) 2rem', padding: '0 min(8vw, 96px)' }}>
  <div style={{
    ...
    <h3 style={{ marginTop: 0, color: '#ffffff', fontWeight: '600' }}>Workflow tips</h3>
    <ul style={{ color: '#ffffff', lineHeight: '1.7' }}>
...
<section style={{ margin: '0 calc(-1 * min(8vw, 96px)) 2rem', padding: '0 min(8vw, 96px)' }}>
  <div style={{
    ...
    <h3 style={{ marginTop: 0, color: '#ffffff', fontWeight: '600' }}>Governance</h3>
    <ul style={{ color: '#ffffff', lineHeight: '1.7' }}>

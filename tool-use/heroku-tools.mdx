...
- **code_exec_ruby** - Execute Ruby code with gem dependencies ([learn more](/tool-use/heroku-tools/code-execution))
- **code_exec_python** - Execute Python code with package dependencies ([learn more](/tool-use/heroku-tools/code-execution))
- **code_exec_go** - Execute Go code with module dependencies ([learn more](/tool-use/heroku-tools/code-execution))
- **code_exec_node** - Execute Node.js code with npm dependencies ([learn more](/tool-use/heroku-tools/code-execution))
- **pg_psql** - Run SQL queries on Heroku Postgres databases ([learn more](/tool-use/heroku-tools/run-sql))
- **doc_reader** - Summarize documentation and surface relevant snippets ([learn more](/tool-use/heroku-tools/doc-reader))
